namespace DataAccess.MappingChinook
{
    ...
    public class InvoiceMap : EntityTypeConfiguration<Invoice>
    {
        public InvoiceMap()
        {
            ...
            // Properties
            this.Property(t => t.BillingAddress).HasMaxLength(70);

            this.Property(t => t.BillingCity).HasMaxLength(40);

            this.Property(t => t.BillingState).HasMaxLength(40);

            this.Property(t => t.BillingCountry).HasMaxLength(40);

            this.Property(t => t.BillingPostalCode).HasMaxLength(10);
